    ...
    <footer className="section">
      <div className="container">
        <div className="lg:grid lg:grid-cols-2">
          <div className="mb-10">
            <h1 className="headline-1 mb-8 lg:max-w-[12ch] reveal-up">
              Passionate to start my dev journey!
            </h1>
            <ButtonPrimary
              href="mailto:zinhtethlaing4@gmail.com"
              label="Contact me"
              classes="group reveal-up"
              icon={
              ...
              <ul>
                {sitemap.map(({ label, href }, index) => (
                  <li key={index}>
                    <a
                      href={href}
                      className="block text-sm text-zinc-400 py-1 transition-colors hover:text-zinc-200 duration-200 reveal-up"
                    >
                      {label}
                    </a>
                  </li>
        ...
        <div className="flex items-center justify-between pt-10 mb-8">
          <a href="#home" className="reveal-up">
            <img src="/images/logo.svg" width={40} height={40} alt="Logo" />
          </a>
          <p className="text-zinc-500 reveal-up">
            &copy; {date.getFullYear()}{" "}
            <span className="text-yellow-500 font-semibold">Zin Htet</span>
          </p>
        </div>
      </div>
    </footer>
